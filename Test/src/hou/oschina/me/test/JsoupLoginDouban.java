...
/**
 * @author houweitao
 * 2015年7月16日 上午10:40:14
 */

public class JsoupLoginDouban {


	public static void main(String[] args) throws Exception {

		JsoupLoginDouban jli = new JsoupLoginDouban();
...
//		System.out.println(d1.select("body"));
		...
		Document con3 = Jsoup.connect("http://www.douban.com/notification/").cookies(map).timeout(10000).get();
