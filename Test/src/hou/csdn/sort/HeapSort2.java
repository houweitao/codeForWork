...
/**
 * @author houweitao 2015年9月18日 上午11:40:40
 *         http://blog.csdn.net/code4grow/article/details/22939521
 */
...
public class HeapSort2 {
	 ...
	 * 堆排序时间复杂度为O(nlog2n),只是用了一个临时变量，所以空间占用率为O(1) 最好情况：时间复杂度：O(nlogn)
	 * 最坏情况：时间复杂度：O(nlogn) 空间占用情况：
	 * 
	 * @param array
	 * @return
	 */
